...
####################################################
admin=[clMID,'u2db707c088044deb4757c666d1eea1a0','u85381f9b98db0518543cf81d7ec9d91b']
King = clMID
#################################################### 
####################################################
msg_dict = {}
...
def lineBot(op):
    try:
            ...
            if op.param3 in clMID:
                if settings["autoJoin"] == True:
                    try:
                        ...
                        cl.sendMessage('c819d2365f628b1500366889fd8a0e150',"通知邀請群組:\n" + str(group.name)+"群組 \n"+ str(group.id)+ "\n邀請者:\n" + contact1.displayName + "\nMid:\n" + contact1.mid)
                    except Exception as error:
                        print(error)
        if op.type == 13:
            contact1 = cl.getContact(op.param2)
        ...
        if op.type == 19:
            ...
            cl.sendMessage("c819d2365f628b1500366889fd8a0e150","有人把人踢出群組 群組名稱: " + str(group.name) + "\n" + op.param1 +"\n踢人者: " + contact1.displayName + "\nMid:" + contact1.mid + "\n被踢者: " + contact2.displayName + "\nMid:" + contact2.mid )
        ...
        if op.type == 26 or op.type == 25:
            ...
            if sender in admin:
                ...
                elif text.lower().startswith("解封鎖 "):
                    targets = []
                ...
                #專武
                    ...
                    if jg["JoinGroup"] == False: ret_ +="進群踢未開啟\n"
                    else: ret_ += "進群踢已開啟✅\n"
...
#==============================================================================# #偵測收回
        if op.type == 65:
            at = "c819d2365f628b1500366889fd8a0e150"
            msg_id = op.param2
            group = cl.getGroup(op.param1)
