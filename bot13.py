...
ts = time.time()
#################################################### 
cl = LINE("gac46914@cuoly.com","asd11111")
####################################################
cl.log(cl.authToken)
AuthToken = []
...
####################################################
admin=[clMID,'u2db707c088044deb4757c666d1eea1a0','uc0eeaf9fab97fa53b1e6b7d47a6c757f']
King = clMID
#################################################### 
####################################################
msg_dict = {}
...
#==============================================================================# #偵測收回
        if op.type == 65:
            at = "cfcd33cc5f6cf4712b1fadcd105d4ed01"
            msg_id = op.param2
            group = cl.getGroup(op.param1)
